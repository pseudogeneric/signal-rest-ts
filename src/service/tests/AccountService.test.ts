...
describe('AccountService', () => {
  ...
  describe('setUsername', () => {
    ...
    const mockUsernameInfo: UsernameInfo = { username: newName, username_link: `link/${newName}` };
  ...
  describe('deleteUsername', () => {
    it('should resolve on successful delete (204)', async () => {
      ...
      await expect(service.deleteUsername(mockNumber)).resolves.toBeUndefined();
      expect(global.fetch).toHaveBeenCalledWith(
        `${mockApiUrl}/v1/accounts/${mockNumber}/username`,
        {
          method: 'DELETE',
  ...
  describe('updateAccountSettings', () => {
    const settings: UpdateAccountSettingsRequest = { read_receipts: true };
    ...
    it('should resolve on successful PUT (204)', async () => {
      ...
      await expect(service.updateAccountSettings(mockNumber, settings)).resolves.toBeUndefined();
      expect(global.fetch).toHaveBeenCalledWith(
    ...
    it('should throw ApiServiceError if status is not 204', async () => {
        ...
        await expect(service.updateAccountSettings(mockNumber, settings)).rejects.toThrow(
          new ApiServiceError(errorMessage, errorStatus)
        );
        expect(global.fetch).toHaveBeenCalledWith(
            `${mockApiUrl}/v1/accounts/${mockNumber}/settings`,
  ...
  describe('setPin', () => {
    ...
    it('should resolve on successful POST (204)', async () => {
      ...
      await expect(service.setPin(mockNumber, pinRequest)).resolves.toBeUndefined();
      expect(global.fetch).toHaveBeenCalledWith(
